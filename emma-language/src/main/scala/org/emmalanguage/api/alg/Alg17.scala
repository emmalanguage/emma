...
case class Alg17[A,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15,B16,B17]
(
  alg1: Alg[A,B1],
  alg2: Alg[A,B2],
  alg3: Alg[A,B3],
  ...
  alg16: Alg[A,B16],
  alg17: Alg[A,B17]
) extends Alg[A,(B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15,B16,B17)] {
  type B = (B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15,B16,B17)
  val zero: B = (
    alg1.zero,
    alg2.zero,
    alg3.zero,
