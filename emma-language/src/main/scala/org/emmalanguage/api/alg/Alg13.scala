...
case class Alg13[A,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13]
(
  alg1: Alg[A,B1],
  alg2: Alg[A,B2],
  alg3: Alg[A,B3],
  ...
  alg12: Alg[A,B12],
  alg13: Alg[A,B13]
) extends Alg[A,(B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13)] {
  type B = (B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13)
  val zero: B = (
    alg1.zero,
    alg2.zero,
    alg3.zero,
