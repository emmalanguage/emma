...
case class Alg14[A,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14]
(
  alg1: Alg[A,B1],
  alg2: Alg[A,B2],
  alg3: Alg[A,B3],
  ...
  alg13: Alg[A,B13],
  alg14: Alg[A,B14]
) extends Alg[A,(B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14)] {
  type B = (B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14)
  val zero: B = (
    alg1.zero,
    alg2.zero,
    alg3.zero,
