...
//
//object comprehension$macro$44 extends scala.AnyRef {
//  import org.apache.flink.api.java.ExecutionEnvironment;
//  import org.apache.flink.api.java.typeutils.ResultTypeQueryable;
//  import eu.stratosphere.emma.api.DataBag;
//  class EmmaMapper00001 extends org.apache.flink.api.common.functions.RichMapFunction[(eu.stratosphere.emma.codegen.flink.TestSchema.FilmFestivalWinner, eu.stratosphere.emma.codegen.flink.TestSchema.IMDBEntry), (String, Int, String)] with ResultTypeQueryable[(String, Int, String)] {
//
//    override def map(x: (eu.stratosphere.emma.codegen.flink.TestSchema.FilmFestivalWinner, eu.stratosphere.emma.codegen.flink.TestSchema.IMDBEntry)): (String, Int, String) = Tuple3.apply[String, Int, String]("Berlin", x._2.year, x._1.title);
...
//  };
//  class EmmaMapper00005 extends org.apache.flink.api.common.functions.RichMapFunction[(eu.stratosphere.emma.codegen.flink.TestSchema.FilmFestivalWinner, eu.stratosphere.emma.codegen.flink.TestSchema.IMDBEntry), (String, Int, String)] with ResultTypeQueryable[(String, Int, String)] {
//
//    override def map(x: (eu.stratosphere.emma.codegen.flink.TestSchema.FilmFestivalWinner, eu.stratosphere.emma.codegen.flink.TestSchema.IMDBEntry)): (String, Int, String) = Tuple3.apply[String, Int, String]("Cannes", x._2.year, x._1.title);
//    override def getProducedType = new SynthesizedTypeInformation002()
//  };
...
//      val outFormat = new org.apache.flink.api.java.io.TypeSerializerOutputFormat[(String, Int, String)]();
//      outFormat.setInputType(typeInformation);
//      outFormat.setSerializer(typeInformation.createSerializer());
//      __input.write(outFormat, "file:///tmp/emma/temp/comprehension$macro$44", org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE)
//    };
//    env.execute("Emma[".$plus("comprehension$macro$44").$plus("]"))
//  };
