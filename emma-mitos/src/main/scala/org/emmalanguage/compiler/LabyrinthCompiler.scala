...
trait mitosCompiler
  extends mitosNormalization
    with mitosLabynization {
  ...
  lazy val prependMemoizeTypeInfoCalls = TreeTransform("mitosCompiler.prependMemoizeTypeInfoCalls", tree => {
