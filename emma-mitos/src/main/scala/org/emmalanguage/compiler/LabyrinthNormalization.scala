...
trait mitosNormalization extends mitosCompilerBase {

  import API._
  import UniverseImplicits._

  // non-bag variables to DataBag
  val mitosNormalize = TreeTransform("mitosNormalize", (tree: u.Tree) => {
    ...
    // first traversal does the mitos normalization. second for block type correction.
