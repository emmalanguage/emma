...
import mitos._
import mitos.operators._
import mitos.partitioners._
...
class mitosCompilerSpec extends BaseCompilerSpec
  ...
  override val compiler = new RuntimeCompiler(codegenDir) with mitosCompiler
  ...
  "normalization" - {
    ...
    "ValDef only" in {
      ...
      applyXfrm(mitosNormalize)(inp) shouldBe alphaEqTo(anfPipeline(exp))
    }
  ...
  "labynization" - {
    ...
    "singSrc rhs" in {
      ...
      val exp = reify {
        ...
        LabyStatics.setTerminalBbid(0)
        LabyStatics.setKickoffSource(0)
        val a = new LabyNode[mitos.util.Nothing, Int](
          "fromNothing",
          ScalaOps.fromNothing[Int]( () => { val tmp = 1; tmp } ),
          0,
          new Always0[mitos.util.Nothing](1),
          null,
    ...
    "databag rhs" in {
      ...
      val exp = reify {
        ...
        LabyStatics.setTerminalBbid(0)
        LabyStatics.setKickoffSource(0)
        val n1 = new LabyNode[mitos.util.Nothing, Seq[Int]](
          "fromNothing",
    ...
    "cross" in {
      ...
      val exp = reify {
        ...
        val n1_1 = new LabyNode[mitos.util.Nothing, Seq[Int]](
          "fromNothing",
          ScalaOps.fromNothing[Seq[Int]](() => {
            val tmp = Seq(1,2,3); tmp
          }),
        ...
        val n2_1 = new LabyNode[mitos.util.Nothing, Seq[String]](
          "fromNothing",
    ...
    "equiJoin" in {
      ...
      val exp = reify {
        ...
        val n1_1 = new LabyNode[mitos.util.Nothing, Seq[String]](
          "fromNothing",
          ScalaOps.fromNothing[Seq[String]](() => {
        ...
        val n2_1 = new LabyNode[mitos.util.Nothing, Seq[Int]](
          "fromNothing",
          ScalaOps.fromNothing[Seq[Int]](() => {
    ...
    "fold2" in {
      ...
      val exp = reify {
        ...
        val n1 = new LabyNode[mitos.util.Nothing, Seq[String]](
          "fromNothing",
          ScalaOps.fromNothing[Seq[String]](() => {
            val tmp = Seq("foo"); tmp
          }),
    ...
    "read Text" in {
      ...
      val exp = reify {
        ...
        val n1 = new LabyNode[mitos.util.Nothing, String](
          "fromNothing",
    ...
    "write csv" in {
      ...
      val exp = reify {
        ...
        val nData = new LabyNode[mitos.util.Nothing, Seq[Int]](
          "fromNothing",
          ScalaOps.fromNothing[Seq[Int]](() => {
            val tmp = Seq(1, 2); tmp
          }),
        ...
        val nPath = new LabyNode[mitos.util.Nothing, String](
          "fromNothing",
          ScalaOps.fromNothing[String](() => {
            val tmp = "path"; tmp
          }),
        ...
        val nCSV = new LabyNode[mitos.util.Nothing, org.emmalanguage.io.csv.CSV](
          "fromNothing",
  ...
  "control flow" - {
    ...
    "with trivial body" in {
      ...
      val exp = reify {
        ...
        val n1 = new LabyNode[mitos.util.Nothing, Int](
          "fromNothing",
        ...
        val ifCondNode = new LabyNode(
          ...
          null,
          new ElementOrEventTypeInfo[mitos.util.Unit](Memo.typeInfoForType[mitos.util.Unit])
        )
